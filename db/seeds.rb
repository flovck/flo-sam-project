...
Lift.create(name: 'Garage Vroom', address: '13 rue de la Gaité 59100 Roubaix', user: User.all.sample)
Lift.create(name: 'Garage de la Rivière', address: '31 rue de la Fonderie 59200 Tourcoing' , user: User.all.sample)
Lift.create(name: 'Speedy up', address: '43 rue de la Blanche Porte 59200 Tourcoing', user: User.all.sample)
Lift.create(name: 'Jacky Mécano', address: '3 rue des Champs 59223 Roncq', user: User.all.sample)
Lift.create(name: 'Ma Belle Auto', address: '143 avenue de la Liberté 59000 Lille', user: User.all.sample)
